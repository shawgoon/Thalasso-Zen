            ...
            <tbody>
                <?php for ($i=0; $i<count($listUsers); $i++) { ?>
                    <tr>
                        ...
                        <td class="action">
                            <form action="http://localhost/Thalasso-Zen/adminUpdateupdateUsers.php" method="post">
                            ...
                            <form action="http://localhost/Thalasso-Zen/adminDelete/deleteUsers.php" method="post">
                                <input type="hidden" name="user_id" value="<?php echo $listUsers[$i]['user_id'] ?>">
